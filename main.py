...
def main():
    ...
    primes = multiprocessing_task.find_primes_in_range(numbers, chunk_size=len(numbers)//multiprocessing_task.cpu_count())
    ...
    asyncio.run(async_task.run_async_tasks(primes))  # Pass primes to async tasks
